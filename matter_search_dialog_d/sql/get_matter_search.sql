...
SELECT
     T.dept_name
	, T.im_main_owner_user_name
	, T.matter_name
	, T.sales_cstmr_corp_name
	, T.target_cstmr_corp_name
	, T.matter_dtl_name
    , T.matter_status1_cd
    , T.matter_status2_cd
	, T.matter_status1_name
    , T.matter_status2_name
    , T.reliability_type_name
    , T.bant_cond_total
    , T.receive_plan_year_month_date
    , T.sales_plan_year_month_date
    , T.record_date
    , T.record_user_name
    , T.matter_id 
    , T.focus_flag
        ...
        FROM
            ( 
                ...
                /*END*/
                    -- 案件名
                /*IF matter_name != null*/
                    AND stm.matter_name LIKE '%' /*$sql_concat*/|| /*matter_name*/'' /*$sql_concat*/|| '%' 
                /*END*/
                    -- 案件内容
                /*IF description != null*/
